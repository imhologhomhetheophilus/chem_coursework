...
// Handle admin remark or score update
$msg = '';
...
// Fetch submissions including leader remark
$subs = $pdo->query("
                                    ...
                                    <td>
                                        <?php if ($students): ?>
                                            <?php foreach ($students as $st): ?>
                                                <?= htmlspecialchars($st['name']) ?> (<?= htmlspecialchars($st['regno'] ?? '—') ?>)<br>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <form method="post" class="d-flex flex-column gap-2">
                                            ...
                                            <select name="remark" class="form-select form-select-sm">
                                                <option value="">--Admin Remark--</option>
                    ...
                    <?php foreach ($subs as $i => $s): ?>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <p class="mb-1"><strong>Students:</strong><br>
                                    <?php if ($students): ?>
                                        <?php foreach ($students as $st): ?>
                                            <?= htmlspecialchars($st['name']) ?> (<?= htmlspecialchars($st['regno'] ?? '—') ?>)<br>
                                        <?php endforeach; ?>
                                ...
                                <p class="mb-1"><strong>Leader Remark:</strong> <?= htmlspecialchars($s['leader_remark'] ?? '—') ?></p>
                                <p class="mb-1"><strong>Admin Remark:</strong> <?= htmlspecialchars($s['remark'] ?? '—') ?></p>
