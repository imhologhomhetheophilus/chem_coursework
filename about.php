  ...
  <div class="container py-5" data-aos="fade-up">
    ...
    <div class="highlight" data-aos="fade-up">
      ...
      <ul>
        ...
        <li>To conduct research on solid minerals and develop technologies to convert them into usable materials or products.</li>
      </ul>
    </div>
    ...
    <div class="section" data-aos="fade-right">
      ...
      <ul>
        ...
        <li>Commitment to selfless and quality service delivery.</li>
        <li>Conducive learning and working environment.</li>
        <li>Diverse staff and student body.</li>
        <li>Production of high-quality graduates competitive locally and internationally.</li>
        <li>Participative and visionary leadership.</li>
      </ul>
    </div>
    ...
    <div class="section" data-aos="fade-right">
      ...
      <ul>
        ...
        <li>To train manpower equipped with ICT competence for the globalized world.</li>
        <li>To be a role model among academic units through quality delivery and results.</li>
      </ul>
    </div>
    ...
    <div class="section mb-5" data-aos="fade-left">
      ...
      <ul>
        ...
        <li>To train personnel capable of supervising industrial processes, especially solid mineral processing.</li>
        <li>To conduct innovative research and develop relevant processing technologies.</li>
        <li>To equip students with problem-solving and ICT skills.</li>
        <li>To expand Chemical Engineering knowledge through research and publications.</li>
        <li>To raise awareness of environmental and ethical factors in engineering practice.</li>
        <li>To develop leadership and teamwork skills essential for the profession.</li>
      </ul>
    </div>
  </div>
