...
<div class="container">
   <div class=" d-md-flex  "  data-aos="fade-down">
...
<li class="nav-item  "><a class="nav-link text-light " href="personnel.php">Personnnels</a></li>
<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Department Laboratories
          </a>
          <ul class="dropdown-menu">
            <li><a  class="dropdown-item" href="mass_transfer_lab.php" target="_self" rel="noope"  >Mass Transfer Operations</a></li>
            <li><a class="dropdown-item" href="heat_transfer_lab.php"  target="_self" rel="noope">Heat Transfer Operations</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="fluid_transfer_lab.php"  target="_self" rel="noope">Fluid and Particles Mechanics</a></li>
            <li><a class="dropdown-item" href="instrument_transfer_lab.php"  target="_self" rel="noope">Instrumentation and Process Control</a></li>
            <li><a class="dropdown-item" href="chemical_reaction_transfer_lab.php"  target="_self" rel="noope">Chemical Reaction Engineering</a></li>
            <li><a class="dropdown-item" href="corrosion_material_transfer_lab.php"  target="_self" rel="noope">Corrosion and Material Science</a></li>
            <li><a class="dropdown-item" href="computer_simulation_transfer_lab.php"  target="_self" rel="noope">Computer Simulation Lab</a></li>
            
          </ul>
        </li>
<li class="nav-item"><a class="nav-link text-light hover:bg-danger " href="experiments.php"> Experiments</a></li>
...
<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a  class="dropdown-item" href="documents/hnd11.pdf" target="_self" rel="noope"  >HND11</a></li>
            <li><a class="dropdown-item" href="documents/hnd1.pdf"  target="_self" rel="noope">HND1</a></li>
            <li><hr class="dropdown-divider"></li>
